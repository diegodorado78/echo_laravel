...
<div class="text-center  my-10">
    ...
    <input type="text" class="w-full rounded-md shadow-lg my-3 border border-blue-900" placeholder="2. Oferte su tarifa" /><br>
            {{-- medio de pago --}}
    <div class=" md:flex justify-items-start shadow-lg mb-3 bg-white rounded-md w-full mx-auto border border-blue-900">
       ...
       <label for="medio" class="text-gray-500 my-3 flex-1">Tarjeta
        ...
        <label for="medio" class="text-gray-500 my-3 flex-1">Efectivo
              ...
              {{-- sitio tutoria --}}
     <div class=" md:flex justify-items-start shadow-lg mb-3 b<g-white rounded-md w-full mx-auto border border-blue-900">
